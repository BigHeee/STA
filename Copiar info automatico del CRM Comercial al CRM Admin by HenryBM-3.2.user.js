        ...
        esperarElemento('#form_altaventa_cif', (campoCif) => {
            ...
            botonGuardar.addEventListener('click', async (e) => {
                ...
                const datos = {
                    ...
                    TelefonoMovil_Cliente: document.querySelector('#form_altaventa_telmovil')?.value.trim(),
                    Telefono2_Cliente: document.querySelector('#form_altaventa_fax')?.value.trim(),
            ...
            botonPegar.addEventListener('click', async (e) => {
                ...
                setTimeout(() => {
                    const mapeo = {
                        ...
                        '#Movil_Cliente': 'TelefonoMovil_Cliente',
